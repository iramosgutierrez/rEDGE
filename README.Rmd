...
2 functions:
`calculate_EDGE2` calculates 1 iteration
`calculate_EDGE2_multiple` allows to calculate several (`n.iter`) replicates, even in parallel using multiple CPU cores.
